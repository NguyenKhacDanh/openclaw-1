...
export const en: TranslationMap = {
  ...
  zalo: {
    botMode: "Bot Mode",
    modePersonal: "Personal Account",
    modeOa: "Official Account (OA)",
    modeLabel: "Chọn chế độ kết nối:",
    phone: "Phone",
    displayName: "Display Name",
    oaId: "OA ID",
    oaName: "OA Name",
    scanQrHint: "Mở Zalo → Quét mã QR bên dưới để đăng nhập:",
    oaModeHint: "Chế độ OA: cấu hình Webhook URL và Secret Token trong Zalo OA Dashboard.",
  },
  facebook: {
    pageId: "Page ID",
    pageName: "Page Name",
    ...
    postPlaceholder: "Nhập nội dung bài viết…",
    postNow: "Post Now",
    schedulePost: "Schedule Post",
    newPost: "New Post",
    refreshToken: "Refresh Token",
    tokenExpiredWarning: "Page Access Token đã hết hạn. Vui lòng refresh token.",
    tokenExpiresSoonWarning: "Page Access Token sắp hết hạn trong vòng 7 ngày.",
  },
  channels: {
    health: {
  ...
  agents: {
    ...
    files: {
      ...
      lines: "lines",
      importFile: "Import File",
      importHint: "Upload a local file to the agent workspace.",
      deleteFile: "Delete File",
      deleteConfirm: "Are you sure you want to delete \"{name}\"? This cannot be undone.",
      newFile: "New File",
      newFileName: "File name (e.g. persona.md)",
      createFile: "Create",
    },
  },
  apiKeys: {
    title: "API Key Priority",
    subtitle: "Highest priority key is tried first. If it fails (rate limit / expired), the next key is used automatically.",
    provider: "Provider",
    keyAlias: "Key / Alias",
    priority: "Priority",
    moveUp: "Move Up",
    ...
    modelSelection: "Models (optional)",
    modelSelectionHint: "Leave unchecked to allow all models for this provider.",
    fallbackChainLabel: "Fallback chain — tried in order:",
    fallbackHint: "Keys marked ACTIVE are currently in use. On rate-limit or expiry, the next key in the chain is tried automatically.",
  },
  scenario: {
    title: "Kịch bản & Data",
    subtitle: "Import và quản lý file kịch bản, data training, FAQ, knowledge base của agent.",
    newFile: "New File",
    newName: "Tên file kịch bản (ví dụ: faq.json, kichban-sale.md)",
    import: "Import Files",
    loadHint: "Tải danh sách file kịch bản của agent để chỉnh sửa.",
    empty: "Chưa có file kịch bản nào. Tạo mới hoặc import file.",
    selectFile: "Chọn file để xem và chỉnh sửa.",
    deleteConfirm: "Xóa file \"{name}\"? Hành động này không thể hoàn tác.",
  },
  telegram: {
    scanQrHint: "Quét QR để thêm bot vào chat:",
  },
  debug: {
