...
export type AppViewState = {
  ...
  apiKeyEntries: import("./views/config-apikeys.js").ApiKeyEntry[];
  apiKeyLoading: boolean;
  apiKeySaving: boolean;
  apiKeyError: string | null;
  apiKeyAddingKey: boolean;
  newApiKeyProvider: string;
  newApiKeyAlias: string;
  newApiKeyValue: string;
  newApiKeyModels: string[];
  apiKeyEditingId: string | null;
  apiKeyEditAlias: string;
  apiKeyEditValue: string;
  apiKeyEditModels: string[];
...
> &
  Pick<CronModelSuggestionsState, "cronModelSuggestions"> & {
    ...
    handleQrTabChange: (tab: "zalo" | "zalo-oa" | "whatsapp" | "telegram") => void;
    handleZaloTokenInput: (v: string) => void;
    handleZaloOaTokenInput: (v: string) => void;
    handleZaloOaIdInput: (v: string) => void;
    handleZaloOaSave: () => Promise<void>;
    handleTelegramTokenInput: (v: string) => void;
    handleTelegramTokenSave: () => Promise<void>;
    handleZaloStart: (force: boolean) => Promise<void>;
    handleZaloWait: () => Promise<void>;
    handleZaloLogout: () => Promise<void>;
    handleZaloSetMode: (mode: "personal" | "oa") => void;
    handleFacebookPost: () => Promise<void>;
    handleFacebookSchedulePost: () => Promise<void>;
    handleFacebookPostDraftChange: (draft: string | null) => void;
    handleFacebookRefreshToken: () => Promise<void>;
    ...
    handleApiKeyLoad: () => Promise<void>;
    handleApiKeyDelete: (id: string) => Promise<void>;
    handleApiKeyDragReorder: (orderedIds: string[]) => Promise<void>;
    handleApiKeyStartAdd: () => void;
    handleApiKeyCancelAdd: () => void;
    handleApiKeyConfirmAdd: () => Promise<void>;
    handleApiKeyProviderChange: (provider: string) => void;
    handleApiKeyAliasChange: (alias: string) => void;
    handleApiKeyValueChange: (value: string) => void;
    handleApiKeyModelsChange: (models: string[]) => void;
    handleApiKeyStartEdit: (key: import("./views/config-apikeys.js").ApiKeyEntry) => void;
    handleApiKeyCancelEdit: () => void;
    handleApiKeyConfirmEdit: () => Promise<void>;
    handleApiKeyEditAliasChange: (alias: string) => void;
    handleApiKeyEditValueChange: (value: string) => void;
    handleApiKeyEditModelsChange: (models: string[]) => void;
  };
